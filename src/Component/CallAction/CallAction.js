...
const CallAction = (props) => {
    return (
        <div className='CallAction'>
            <div className='CallAction-main'>
                <div className='CallAction-box'>
                    <div className="callaction-left">
                        <img src={call}alt="" />
                    </div>
                    <div className="callaction-right">
                        {/* <h4>Affordable Repair Solutions</h4> */}
                        <h2>Schedule a call with us for more information.</h2>
                        <div className="callAction-btn">
